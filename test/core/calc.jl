...
for (src, ast, val) in
    ...
    @test isapprox(calc(parse_one(src, all)[1]), val)
    println("$src = $val")
end


# some regression tests
@test isapprox(calc(parse_one("-5.0/7.0+5.0-5.0", all)[1]), -0.7142857142857144)
@test isapprox(eval(parse("-5.0/7.0+5.0-5.0")), -0.7142857142857144)
@test isapprox(calc(parse_one("(0.0-9.0)", all)[1]), -9.0)
@test isapprox(calc(parse_one("((0.0-9.0))", all)[1]), -9.0)
@test isapprox(calc(parse_one("-((0.0-9.0))", all)[1]), 9.0)
@test isapprox(calc(parse_one("(-6.0/5.0)", all)[1]), -1.2)
@test isapprox(calc(parse_one("3.0*-((0.0-9.0))", all)[1]), 27)
@test isapprox(calc(parse_one("-9.0*3.0*-((0.0-9.0))*9.0", all)[1]), -2187.0)
@test isapprox(calc(parse_one("5.0/3.0*(-6.0/5.0)", all)[1]), -2.0)
@test isapprox(calc(parse_one("3*6-9*1", all)[1]), 9)
@test isapprox(calc(parse_one("4.0-5.0-0.0/8.0/5.0/3.0*(-6.0/5.0)-9.0*3.0*-((0.0-9.0))*9.0", all)[1]), -2188.0)
@test isapprox(calc(parse_one("((-6.0/6.0+7.0))*((-1.0-3.0/5.0))+-(9.0)", all)[1]), -18.6)
